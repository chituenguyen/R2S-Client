...
const updateProduct = async ({ id, formData }: { id: number; formData: FormData }): Promise<Product> => {
  ...
  try {
    ...
    if (!responseText) {
      return { ...productData, id } as Product; // Return updated data if response is empty
    }

    try {
      return JSON.parse(responseText);
    } catch (e) {
      // If parsing fails but update was successful, return the updated data
...
const Products = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Errors are handled in mutation's onError
    }
  };
                ...
                <div className="p-4">
                  ...
                  <div className="mt-4 flex gap-2">
                    <button 
                      ...
                      className="flex-1 px-3 py-2 text-sm bg-gray-100 text-gray-600 rounded-lg hover:bg-gray-200 flex items-center justify-center gap-1"
                    >
                    ...
                    <button 
                      ...
                      className="flex-1 px-3 py-2 text-sm bg-red-50 text-red-600 rounded-lg hover:bg-red-100 flex items-center justify-center gap-1"
