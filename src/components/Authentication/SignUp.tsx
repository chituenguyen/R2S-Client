...
function SignUp(){
  ...
  <div className="w-1/3 bg-white flex flex-col justify-center p-20">
    ...
    <input type="text" placeholder="Name" className="border-b border-gray-300 rounded-md p-2 mb-4 w-full" />
    <input type="text" placeholder="Email or Phone Number" className="border-b border-gray-300 rounded-md p-2 mb-4 w-full" />
    <input type="password" placeholder="Password" className="border-b border-gray-300 rounded-md p-2 mb-6 w-full" />
