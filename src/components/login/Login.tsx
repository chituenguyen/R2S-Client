        ...
        <div className="h-96 w-[675px] bg-slate-100 shadow-xl justify-self-center grid content-center rounded-md font-sans max-w-5xl">
          ...
          <div className="justify-items-center mt-5">
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <button
                type="submit"
                className="w-[386px] h-10 text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-full text-sm px-5 py-2.5 text-center ml-36 mt-3 shadow-xl"
              >
                Sign in
              </button>
            </form>
