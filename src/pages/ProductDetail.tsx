        ...
        <div className="w-full ml-auto">
          ...
          <div className="flex items-center gap-4 my-6">
            ...
            className={`w-[165px] h-[44px] flex items-center justify-center rounded ${
              product.stock === 0 ? "bg-gray-400 cursor-not-allowed" : "bg-red-500 text-white"
             }`}
          ...
          <div className="border border-gray-400 rounded">
            <div className="p-4 flex items-start gap-3">
              <img src="src/images/fast-delivery-icon-free-vector.jpg" alt="icon-delivery2" className="w-[40px] h-[40px] object-contain" />
              <div>
            ...
            <div className="border-t border-t-gray-400 p-4 flex items-start gap-3">
              <img src="src/images/png-clipart-money-back-guarantee-computer-icons-search-button-miscellaneous-service.png" alt="Icon-return" className="w-[40px] h-[40px] object-contain" />
              <div>
